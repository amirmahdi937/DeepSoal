"""
Django settings for deepsoal_backend project.
...
SECRET_KEY = 'django-insecure-8=9ywpj!)^8u!e$g^crn=u5f8al!kr6o%=&6ww@ccoguo+pruk'
...
ROOT_URLCONF = 'deepsoal_backend.urls'
...
WSGI_APPLICATION = 'deepsoal_backend.wsgi.application'
